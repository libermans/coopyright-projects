...
## Введение
Здесь описаны новые принципы для ведения проектов, которые будут распространятся по [**Coopyright License**](https://github.com/libermans/coopyright-license). Описание включает то, как должна вестись и финансироваться разработка продукта, и как происходить распространение произведенного продукта. 
